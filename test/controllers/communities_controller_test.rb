...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { location: @community.location, name: @community.name, scope: @community.scope, verified: @community.verified }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { location: @community.location, name: @community.name, scope: @community.scope, verified: @community.verified }
    assert_redirected_to community_path(assigns(:community))
  end
